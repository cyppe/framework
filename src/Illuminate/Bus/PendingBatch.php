...
class PendingBatch
{
     ...
     *
     * The ID must be a canonical lowercase, timestamp-first UUID generated by
     * Str::orderedUuid(). Batch repositories use the ID for listings and
     * pagination, so other UUID layouts do not preserve their ordering.
    ...
    {
        if (! Str::isUuid($id, 4) || Str::lower($id) !== $id) {
            throw new InvalidArgumentException('The batch ID must be a canonical lowercase UUID generated by Str::orderedUuid().');
        }
    }
