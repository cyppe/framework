...
class BusPendingBatchTest extends TestCase
{
    ...
    public function test_pending_batch_rejects_ids_that_cannot_preserve_repository_ordering(string $id)
    {
        ...
        $this->expectExceptionMessage('The batch ID must be a canonical lowercase UUID generated by Str::orderedUuid().');
    ...
    public static function invalidBatchIds()
    {
        return [
            ...
            'version 7 UUID' => ['01890f2d-3b5a-7cc0-98c4-dc0c0c07398f'],
            'uppercase UUID' => ['A25A7B0A-4BA4-460E-AC71-AE7BE182AF50'],
        ];
    }
